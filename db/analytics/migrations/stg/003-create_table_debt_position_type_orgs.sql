...
CREATE TABLE IF NOT EXISTS stg.debt_position_type_orgs (
...
CREATE INDEX IF NOT EXISTS debt_position_type_orgs_processed_time_idx ON stg.debt_position_type_orgs (processed_time);
